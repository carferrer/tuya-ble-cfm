...
El sensor `alarm_lock` restaura tras reiniciar HA su último valor válido guardado localmente. Una nueva lectura DP21 de la cerradura tiene prioridad sobre el valor restaurado. La restauración no abre una conexión BLE ni vuelve a emitir eventos de alarma; hasta recibir una lectura nueva, el estado mostrado es el último conocido.
